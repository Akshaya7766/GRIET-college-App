...
void main() => runApp(const Ashc ());

class Ashc extends StatelessWidget {
  const Ashc  ({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('ANTI SEXUAL-HARASSMENT CELL'),
      ),
      body: SingleChildScrollView(
        child:Container(
          ...
          child: Column(
            ...
            children:  <Widget> [
           const  Text('TheSexual Harassment of Women at Workplace (Prevention, Prohibition and Redressal) Act, 2013is alegislative actinIndiawhich came into force from 09 December 2013. This is anAct to provide protection againstsexual harassment of women at workplace and for the prevention and redressal of complaints of sexual harassment and for matters connected therewith or incidental thereto.This will contribute to realization of their right to gender equality, life and liberty and equality in working conditions everywhere. The sense of security at the workplace will improve womens participation in work, resulting in their economic empowerment and inclusive growth. Under the Act, which also covers students in schools and colleges as well as patients in hospitals, employers and local authorities will have to set up grievance committees to investigate all complaints.',
            ...
            Container(
             ...
             image: AssetImage('assets/ASHC1.jpg'),
             fit: BoxFit.fill
              ),
             ),
            ),
             ...
             image: DecorationImage(
             image: AssetImage('assets/ASHC 2.jpg'),
             fit: BoxFit.fill
              ),
             ),
            ),
             ...
             image: DecorationImage(
             image: AssetImage('assets/ASHC3.jpg'),
             fit: BoxFit.fill
              ),
             ),
            ),
            const  Text('The list of members and terms of references are given below:In case, if the complaint is against any staff member of the committee then the Principal shall nominate appropriate Chair or member for the enquiry.',
             textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
            ...
            const  Text('The Anti-Sexual Harassment Cell of GRIET is responsible for initiating the necessary process of inquest on receipt of complaint from any aggrieved individual or Dean Discipline.',
             textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
          ...
          height: 1.2),
            ...
            const  Text('1. To discuss and suggest methods to promote gender amity amongst all GRIET employees and students.',
             textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
              ...
              const  Text('2. To suggest awareness video lectures/ workshops for GRIET students and staff members on different aspects of women welfare.',
             textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
               ...
               const  Text('3. To address the gender discrimination and sexual harassment cases whenever reported and recommend appropriate necessary action.',
             textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
               ...
               const  Text('4. To arbitrate sexual harassment cases and recommend suitable punishments to the Dean Discipline for further action.',
             textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
             ...
             textAlign: TextAlign.justify,
              style: TextStyle(
               ...
               const  Text('6. To consider any other matter on women’s issues referred to the committee.',
             textAlign: TextAlign.justify,
              style: TextStyle(
                fontSize: 18,
                fontWeight: FontWeight.w400,
          ...
          height: 1.2),
            ...
            Container(
             ...
             image: DecorationImage(
             image: AssetImage('assets/Anti1.jpg'),
             fit: BoxFit.contain
              ),
             ),
            ),
          ...
          height: 1.2),
             ...
             image: DecorationImage(
             image: AssetImage('assets/Anti3.jpg'),
             fit: BoxFit.contain
              ),
             ),
            ),
            Container(
             ...
             image: DecorationImage(
             image: AssetImage('assets/Anti4.jpg'),
             fit: BoxFit.contain
              ),
             ),
            ),
